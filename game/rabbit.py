...
def run():
    ...
    jump_sound = pygame.mixer.Sound(sound_path + 'jump.wav')
    die_sound = pygame.mixer.Sound(sound_path + 'die.wav')
    checkPoint_sound = pygame.mixer.Sound(sound_path + 'checkPoint.wav')
    ...
    def load_image(
        ...
        fullname = os.path.join('assets/image/rabbit', name)
    ...
    def load_sprite_sheet(
        ...
        fullname = os.path.join('assets/image/rabbit', sheetname)
    ...
    class Rabbit():
        ...
        def __init__(self, sizex=-1, sizey=-1):
            self.images, self.rect = load_sprite_sheet(
                'finalRabbit.PNG', 5, 1, sizex, sizey, -1)
            self.images1, self.rect1 = load_sprite_sheet(
                'minimini.png', 2, 1, 59, sizey, -1)
    ...
    class Ground():
        def __init__(self, speed=-5):
            self.image, self.rect = load_image('runningGround.png', -1, -1, -1)
            self.image1, self.rect1 = load_image('runningGround.png', -1, -1, -1)
    ...
    class Cloud(pygame.sprite.Sprite):
        def __init__(self, x, y):
            pygame.sprite.Sprite.__init__(self, self.containers)
            self.image, self.rect = load_image('skyCloud.png', int(90 * 30 / 42), 30, -1)
            self.speed = 1
            self.rect.left = x
            self.rect.top = y
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.KEYDOWN:
                        if event.key == pygame.K_SPACE or event.key == pygame.K_UP:
                            ...
                            temp_rabbit.movement[1] = -1 * temp_rabbit.jumpSpeed
    ...
    def gameplay():
        ...
        while not gameQuit:
            ...
            while not gameOver:
                    ...
                    for event in pygame.event.get():
                        ...
                        if event.type == pygame.KEYDOWN:
                            if event.key == pygame.K_SPACE:
                                if playerRabbit.rect.bottom == int(0.98 * height):
                            ...
                            if event.key == pygame.K_DOWN:
                                if not (playerRabbit.isJumping and playerRabbit.isDead):
                ...
                if len(eagles) == 0 and random.randrange(0, 200) == 10 and counter > 500:
                    for l in last_obstacle:
