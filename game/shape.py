...
class Shape(object):
    def __init__(self, name, state, color, row_no, column_no, head, blocks):
        self.name = name
        self.state = state
        self.row_no = row_no
    ...
    def draw(self, screen):
        for i in self.blocks:
            pygame.draw.rect(screen, self.color.value, (50 + (i[1] * 30), 50 + (i[0] * 30), 30, 30), 2)
            pygame.draw.rect(screen, self.color.value, (50 + (i[1] * 30) + 5, 50 + (i[0] * 30) + 5, 21, 21))

    def draw_next(self, screen, x_position):
        for i in self.blocks:
            pygame.draw.rect(screen, self.color.value, (x_position + (i[1] * 15), 170 + (i[0] * 15), 15, 15))
            pygame.draw.rect(screen, tetrisColor.Color.BLACK.value, (x_position + (i[1] * 15), 170 + (i[0] * 15), 15, 15), 1)
...
class SmashBoy(Shape):
    def __init__(self, row_no, column_no):
        super().__init__('SmashBoy', None, tetrisColor.Color.FIREBRICK, row_no, column_no, [0, 4], [[1, 4], [0, 5], [1, 5]])
...
class Hero(Shape):
    ...
    def __init__(self, row_no, column_no):
        super().__init__('Hero', Direction.DOWN, tetrisColor.Color.GREEN, row_no, column_no, [0, 6], [[0, 4], [0, 5], [0, 7]])
...
class RhodeIsland(Shape):
    def __init__(self, row_no, column_no):
        super().__init__('RhodeIsland', Direction.UP, tetrisColor.Color.TEAL, row_no, column_no, [0, 4],
                         [[0, 5], [1, 4], [1, 3]])
...
class Cleveland(Shape):
    def __init__(self, row_no, column_no):
        super().__init__('Cleveland', Direction.UP, tetrisColor.Color.GOLD, row_no, column_no, [0, 4],
                         [[0, 3], [1, 4], [1, 5]])
...
class OrangeRicky(Shape):
    def __init__(self, row_no, column_no):
        super().__init__('OrangeRicky', Direction.RIGHT, tetrisColor.Color.ORANGE, row_no, column_no, [1, 5],
                         [[1, 4], [1, 6], [0, 6]])
...
class BlueRicky(Shape):
    def __init__(self, row_no, column_no):
        super().__init__('BlueRicky', Direction.RIGHT, tetrisColor.Color.BLUE, row_no, column_no, [1, 5],
                         [[1, 4], [1, 6], [0, 4]])
...
class TeeWee(Shape):
    def __init__(self, row_no, column_no):
        super().__init__('TeeWee', Direction.DOWN, tetrisColor.Color.PURPLE, row_no, column_no, [1, 5],
                         [[0, 5], [1, 4], [1, 6]])
